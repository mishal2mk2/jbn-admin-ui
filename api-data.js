...
const Production = {
  productionStatus: {
    "1":{
        isStarted: true,
        percentCompleted: 10, //in percentage should be less than 100 and not less than 0
    },
    "2":{
        isStarted: true,
        percentCompleted: 5, //in percentage should be less than 100 and not less than 0
    },
    "3":{
        isStarted: false,
        percentCompleted: 0, //in percentage should be less than 100 and not less than 0
    },
    "4":{
        isStarted: false,
        percentCompleted: 0, //in percentage should be less than 100 and not less than 0
