...
@Component({
  ...
  templateUrl: './material-estimate-form.component.html',
  styleUrl: './material-estimate-form.component.css',
})
export class MaterialEstimateFormComponent implements OnInit, OnChanges {
